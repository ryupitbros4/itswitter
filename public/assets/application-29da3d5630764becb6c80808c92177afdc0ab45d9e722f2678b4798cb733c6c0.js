...
(function() {
  this.FollowSystem = (function() {
    ...
    FollowSystem.prototype.unfollowIt = function(restaurantNumber) {
      var newId, newIdTen, newURL, thisId, thisIdTen;
  ...
  this.GoodnessSystem = (function() {
    ...
    GoodnessSystem.prototype.notGoodIt = function(commentNumber, restaurantNumber, userNumber) {
      var commentId, newId, newIdTen, newURL, restaurantId, thisId, thisIdTen, userId;
      ...
      if (document.getElementById(thisIdTen)) {
        ...
        document.getElementById(thisIdTen).id = newIdTen;
        return document.getElementById(newIdTen).parentNode.setAttribute('action', newURL);
      }
    };
